...
function CompanyListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CompanyInterface[]>(
    ...
    () =>
      getCompanies({
        relations: ['user', 'article.count', 'garden.count', 'video.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('garden', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>garden</Th>}

...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Garden', path: '/gardens', entity: 'garden', service: AccessServiceEnum.PROJECT, icon: FiSun },
    { name: 'Plant', path: '/plants', entity: 'plant', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Question',
      path: '/questions',
      entity: 'question',
